...
const { goldColor, noneColor } = require("../../../database/utils/color/color.json");
...
module.exports = class BattlesCommand extends BaseCommand {
    ...
    async run(bot, message, args) {
        ...
        .setTitle(putEmoji(bot,"910558106008817764")+" RTSolBattles Results Tournament Selection")
        .setColor("#15E08C")
        .setFooter("RottenVille Automate Rewards System")

        if (winner != "DRAW") {
            embed.setDescription(`**${putEmoji(bot,"918868797367148604")} ${_player1} Votes: ${_p1Votes} VS ${putEmoji(bot,"918869733783269436")} ${_player2} Votes: ${_p2Votes} | Winner of this Tournament Selection is ${winner} | ${_sizeVotes*100} AR ${putEmoji(bot,"905441646362120232")} Reward**`)
            embed.addField("Voters Winners |"+ `** + 220 AR ${putEmoji(bot,"905441646362120232")} Reward**`,_arrayWinner)
        }else{
            embed.setDescription(`**The Tournament Selection finish in DRAW VOTES**`)
        }

        message.channel.send(`${putEmoji(bot,"910545619238678538")} **<@&895850023311540225> Check the Results of the Tournament Battles.**`,embed)
        console.log("Votos por el jugador 1: "+_p1Votes+" Votos por el jugador 2: "+_p2Votes);
    }
};
